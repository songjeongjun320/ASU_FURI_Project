...
def main(img, gr_bl_constant, gr_bl_constant_reverse, h_max, h_min, result_possibility, company_list):
    ...
    img_denoised,height,width,channel = img_denoise(img)
    show('cutted_denoised_img', img_denoised)
    ...
    show('temp_result4', temp_result4) 
